        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-4">
            ...
            <ul className='grid grid-cols-3'>
              {
                arrayHeThongRap.map((heThongRap, index) => {
                
                  return (
                    <li key={index} className='w-16 h-16 my-5 border-2  border-red-300 rounded-full'>
                      <img src={ heThongRap.logo} alt="" className='w-full h-full'/>
                    </li>
                  );
                })
              }
          ...
          <div className="ml-20 col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium">Moblie App</p>
            <ul className='mt-5' style={{fontWeight: "bold", fontSize:"2rem"}}>
              <li>
                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400"><AndroidOutlined /></a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400"><AppleOutlined /></a>
              </li>
            </ul>
          </div>
        </div>

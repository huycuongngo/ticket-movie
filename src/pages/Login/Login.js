      ...
      <form onSubmit={(e) => {
        ...
        <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
          <h2 className="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
              xl:text-bold">Dang Nhap</h2>
          <div className="mt-12">
            <div>
              <div>
                <div className="text-sm font-bold text-gray-700 tracking-wide text-left">Tai khoan</div>
                <input name='taiKhoan' onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Tai khoan..." />
              </div>
              <div className="mt-8">
                ...
                <input name='matKhau' onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Mat khau..." />
              </div>
              <div className="mt-10">
            ...
            <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
              Ban chua co tai khoan ? <a onClick={() => {
                history.push("/register")
              }} className="cursor-pointer text-indigo-600 hover:text-indigo-800">Dang Ky</a>
            </div>
          </div>
        </div>
      </form>
